...
public class GameBoard {
    ...
    public GameBoard() {
        ...
        tiles.add(new RisikoEvent(12, "Risiko Ereignis"));
        ...
        tiles.add(new BankEvent(16, "Bank Ereignis"));
        ...
        tiles.add(new RisikoEvent(22, "Risiko Ereignis"));
        ...
        tiles.add(new BankEvent(26, "Bank Ereignis"));
        ...
        tiles.add(new RisikoEvent(32, "Risiko Ereignis"));
        ...
        tiles.add(new BankEvent(36, "Bank Ereignis"));
