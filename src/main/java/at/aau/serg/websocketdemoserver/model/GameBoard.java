...
public class GameBoard {
    ...
    public GameBoard() {
        ...
        tiles.add(new Event(12, "Risiko Ereignis"));
        ...
        tiles.add(new Event(16, "Bank Ereignis"));
        ...
        tiles.add(new Event(22, "Risiko Ereignis"));
        ...
        tiles.add(new Event(26, "Bank Ereignis"));
        ...
        tiles.add(new Event(32, "Risiko Ereignis"));
        ...
        tiles.add(new Event(36, "Bank Ereignis"));
