...
public class GameBoard {
    ...
    public GameBoard() {
        ...
        tiles.add(new RisikoEventTile(12, "Risiko Ereignis"));
        ...
        tiles.add(new BankEventTile(16, "Bank Ereignis"));
        ...
        tiles.add(new RisikoEventTile(22, "Risiko Ereignis"));
        ...
        tiles.add(new BankEventTile(26, "Bank Ereignis"));
        ...
        tiles.add(new RisikoEventTile(32, "Risiko Ereignis"));
        ...
        tiles.add(new BankEventTile(36, "Bank Ereignis"));
